...
public class MapDialog {
    ...
    public static void showMapDialog(Context context, Map<String, String> map, TextView unitName, TextView unitCode) {
        // Create dialog
        ctx = context;
        ...
        MapAdapter adapter = new MapAdapter(map, unitName, unitCode, dialog);
    ...
    static class MapAdapter extends RecyclerView.Adapter<MapAdapter.ViewHolder> {
        ...
        public MapAdapter(Map<String, String> map, TextView unitName, TextView unitCode, Dialog dialog) {
