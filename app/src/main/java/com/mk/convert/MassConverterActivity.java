...
import com.mk.controller.MassConverterController;
...
public class MassConverterActivity extends BaseActivity {
    ...
    MassConverterController controller;
    MassConverterModel model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mass_activity_layout);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.mass_activity_layout), (v, insets) -> {
        ...
        model = new MassConverterModel(this);
        controller = new MassConverterController(model,this);


    }
    protected void initializeViews(){
        selectedTextView=null;
        unit1Name=findViewById(R.id.massFirstListView);
        unit2Name=findViewById(R.id.massSecondListView);
        unit1Code=findViewById(R.id.massFirstListViewCode);
        unit2Code=findViewById(R.id.massSecondListViewCode);
        unit1Value=findViewById(R.id.massFirstListViewValue);
        unit2Value=findViewById(R.id.massSecondListViewValue);
    ...
    private void showDialog(TextView unitName,TextView unitCode){
        // get map from model
        Map<String, String> map = model.getMassUnitsWithCodes();
