...
import com.mk.controller.TimeConverterController;
...
public class TimeConverterActivity extends BaseActivity {
    ...
    TimeConverterController controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.time_activity_layout), (v, insets) -> {
        ...
        model = new TimeConverterModel(this);
        controller = new TimeConverterController(model,this);


    }
    protected void initializeViews(){
        selectedTextView=null;
        unit1Name=findViewById(R.id.timeFirstListView);
        unit2Name=findViewById(R.id.timeSecondListView);
        unit1Code=findViewById(R.id.timeFirstListViewCode);
        unit2Code=findViewById(R.id.timeSecondListViewCode);
        unit1Value=findViewById(R.id.timeFirstListViewValue);
        unit2Value=findViewById(R.id.timeSecondListViewValue);
    ...
    private void showDialog(TextView unitName,TextView unitCode){
        // get map from model
        Map<String, String> map = model.getTimeUnitsWithCodes();
