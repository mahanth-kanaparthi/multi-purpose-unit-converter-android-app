...
import com.mk.controller.EnergyConverterController;
...
public class EnergyConverterActivity extends BaseActivity{
    ...
    EnergyConverterController controller;
    EnergyConverterModel model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.energy_activity_layout), (v, insets) -> {
        ...
        model = new EnergyConverterModel(this);
        controller = new EnergyConverterController(model,this);


    }
    protected void initializeViews(){
        selectedTextView=null;
        unit1Name=findViewById(R.id.energyFirstListView);
        unit2Name=findViewById(R.id.energySecondListView);
        unit1Code=findViewById(R.id.energyFirstListViewCode);
        unit2Code=findViewById(R.id.energySecondListViewCode);
        unit1Value=findViewById(R.id.energyFirstListViewValue);
        unit2Value=findViewById(R.id.energySecondListViewValue);
    ...
    private void showDialog(TextView unitName,TextView unitCode){
        // get map from model
        Map<String, String> map = model.getEnergyUnitsWithCodes();
