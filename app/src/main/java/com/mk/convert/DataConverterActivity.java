...
import com.mk.controller.DataConverterController;
...
public class DataConverterActivity extends BaseActivity {
    ...
    DataConverterController controller;
    DataConverterModel model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.data_activity_layout), (v, insets) -> {
        ...
        model = new DataConverterModel(this);
        controller = new DataConverterController(model,this);


    }
    protected void initializeViews(){
        selectedTextView=null;
        unit1Name=findViewById(R.id.dataFirstListView);
        unit2Name=findViewById(R.id.dataSecondListView);
        unit1Code=findViewById(R.id.dataFirstListViewCode);
        unit2Code=findViewById(R.id.dataSecondListViewCode);
        unit1Value=findViewById(R.id.dataFirstListViewValue);
        unit2Value=findViewById(R.id.dataSecondListViewValue);
    ...
    private void showDialog(TextView unitName,TextView unitCode){
        // get map from model
        Map<String, String> map = model.getDataUnitsWithCodes();
