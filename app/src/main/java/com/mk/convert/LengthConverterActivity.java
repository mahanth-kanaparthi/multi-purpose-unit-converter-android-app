...
public class LengthConverterActivity extends BaseActivity {
    ...
    LengthConverterController controller;
    LengthConverterModel model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.length_activity_layout);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.length_activity_layout), (v, insets) -> {
        ...
        model = new LengthConverterModel(this);
    ...
    protected void initializeViews(){
        ...
        unit1Name=findViewById(R.id.lengthFirstListView);
        unit2Name=findViewById(R.id.lengthSecondListView);
        unit1Code=findViewById(R.id.lengthFirstListViewCode);
        unit2Code=findViewById(R.id.lengthSecondListViewCode);
        unit1Value=findViewById(R.id.lengthFirstListViewValue);
        unit2Value=findViewById(R.id.lengthSecondListViewValue);
    ...
    private void showDialog(TextView unitName,TextView unitCode){
        // get map from model
        Map<String, String> map = model.getLengthUnitsWithCodes();
